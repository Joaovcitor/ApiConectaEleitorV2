...
namespace ConectaEleitor.Infrastructure.Migrations
{
    ...
    [Migration("20260615170855_AddTags")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConectaEleitor.Domain.Entities.Tag", b =>
                {
            ...
            modelBuilder.Entity("ConectaEleitor.Domain.Entities.TagCitizen", b =>
                {
                    b.Property<Guid>("TagId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("TagId", "CitizenId");

                    b.HasIndex("CitizenId");

                    b.ToTable("TagCitizens");
                });
            ...
            modelBuilder.Entity("ConectaEleitor.Domain.Entities.TagCitizen", b =>
                {
                    b.HasOne("ConectaEleitor.Domain.Entities.Citizen", "Citizen")
                        .WithMany("TagCitizens")
                        .HasForeignKey("CitizenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConectaEleitor.Domain.Entities.Tag", "Tag")
                        .WithMany("TagsCitizens")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
